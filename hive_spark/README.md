...
```sh
sudo docker cp breweries.csv namenode:breweries.csv
```
...
/spark/bin/pyspark --master spark://spark-master:7077 --conf hive.metastore.uris=thrift://gtcrd-ckbla01d:9083
```
...
# Invalid Spark URL
https://cloud.tencent.com/developer/ask/sof/130415


/spark/bin/pyspark --master spark://spark-master:7077 --conf hive.metastore.uris=thrift://gtcrd-ckbla01d:9083 --conf spark.driver.host=localhost
...
/spark/bin/spark-submit --master spark://spark-master:7077 --deploy-mode client --conf hive.metastore.uris=thrift://gtcrd-ckbla01d:9083 --conf spark.driver.host=localhost demo.py
/spark/bin/spark-submit --master spark://spark-master:7077 --deploy-mode client --conf spark.driver.host=localhost /demo.py
/spark/bin/spark-submit --master spark://spark-master:7077 --conf spark.driver.host=localhost /demo.py
